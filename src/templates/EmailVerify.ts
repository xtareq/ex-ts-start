...
export const EmailVerifyTemplate = (name:string, code:string)=>{
    return `
    ...
    <img src="https://api2.saxonmarket.com/static/images/saxon.png" class="logo" alt="SantaEats Logo" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; max-width: 100%; border: none; height: 75px; max-height: 60px; width: 100px;">
    </a>
    </td>
    </tr>
    ...
    <p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">© 2021 SaxonPrime. All rights reserved.</p>
